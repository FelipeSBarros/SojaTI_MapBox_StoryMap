var config = {
    ...
    byline: 'Por: Marcos Hermanson',
    footer: 'Desenvolvido por <a href="https://felipesbarros.github.io" target="_blank">Felipe Sodré Mendes Barros</a> com <a href="https://github.com/mapbox/storytelling" target="_blank">Mapbox Storytelling</a>',
    chapters: [
//        disclaimer
        {
            id: 'disclaimer',
            ...
            title: '',
            image: './img/cover.png',
            description: '<h1>Aviso importante!</h1><br><h3>A presente reportagem foi desenvolvida pelo Instituto  <a href="https://ojoioeotrigo.com.br/">O Joio E o Trigo</a> . Ainda que tenha participado na produção de dados, os direitos autorias pertencem a eles.<br><br>A presente publicação é apenas uma parte da reportagem completa usada como estudo no uso do MapBox StoryMap</h3>',
            location: {
...
//        TIs
        {
            ...
            title: '',
            image: '',
            description: '<h4>Segundo a pesquisa inédita, <strong>das 72 TIs do estado, 21 têm plantações de commodities no seu interior</strong>. A natureza dos casos varia entre arrendamentos, invasões e territórios contestados judicialmente.</h4>',
            location: {
...
//        wedeze
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'As TIs mais afetadas',
            image: '',
            description: '<h4>De acordo com o levantamento, a terra indígena mais afetada é Wedeze, situada no município de Cocalinho (MT), com 13 mil hectares de lavoura. Wedeze fica colada a outro território já homologado, Pimentel Barbosa. Os territórios estão separados pelo Rio das Mortes, sagrado para o povo Xavante. A TI Wedeze foi reconhecida como área indígena em um estudo de 2007 da Funai.</h4>',
            location: {
